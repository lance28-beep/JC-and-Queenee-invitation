...
const galleryHashtag = "#JCAndQueeneeWedding"
...
export function Gallery() {
  ...
  return (
    <Section
      id="gallery"
      className="relative bg-[#FAB1AA] py-10 sm:py-12 md:py-16 lg:py-20 overflow-hidden"
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Gradient overlays */}
        <div className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-[#FAB1AA]/90 via-[#F3D1C8]/70 to-transparent" />
        <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-[#FAB1AA]/95 via-[#F3D1C8]/70 to-transparent" />
        {/* Radial spotlight */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(243,209,200,0.3),transparent_55%)] opacity-90" />

        {/* Floating decorative circles */}
        <div className="absolute top-6 left-8 w-32 h-32 bg-[#F3D1C8]/26 rounded-full blur-3xl animate-pulse-slow" />
        <div className="absolute top-16 right-12 w-24 h-24 bg-[#FAB1AA]/26 rounded-full blur-2xl animate-pulse-slow" style={{ animationDelay: "1s" }} />
        <div className="absolute bottom-20 left-16 w-28 h-28 bg-white/22 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: "2s" }} />
        <div className="absolute bottom-10 right-10 w-20 h-20 bg-[#F3D1C8]/26 rounded-full blur-2xl animate-pulse-slow" style={{ animationDelay: "0.5s" }} />
      </div>
      ...
      <div className="relative z-10 text-center mb-8 sm:mb-10 md:mb-12 px-4">
        ...
        <p className={`${cormorant.className} text-xs sm:text-sm md:text-base text-white/95 font-light max-w-xl mx-auto leading-relaxed mt-3`}>
          Beautiful frames capturing the journey of JC and Queenee — each photograph a precious memory of laughter, love, and the moments that led us to forever.
        </p>

        <div className="flex items-center justify-center gap-2 mt-6">
          <div className="w-8 sm:w-12 h-px bg-gradient-to-r from-transparent via-white/80 to-transparent" />
          <motion.div
            className="w-1.5 h-1.5 rounded-full bg-[#F3D1C8]/80"
            animate={{
              scale: [1, 1.3, 1],
              opacity: [0.7, 1, 0.7],
            }}
          ...
          <div className="max-w-5xl w-full">
            {isLoading ? (
              <div className="flex items-center justify-center h-48 sm:h-60 md:h-72">
                <div className="w-10 h-10 border-[3px] border-white/40 border-t-[#FAB1AA] rounded-full animate-spin" />
              </div>
            ) : (
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 sm:gap-3.5 md:gap-4.5">
                {galleryItems.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="absolute -inset-0.5 bg-gradient-to-br from-[#FAB1AA]/45 via-[#F3D1C8]/28 to-white/20 rounded-lg sm:rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm" />
                    ...
                    {/* Image counter badge */}
                    <div className="absolute top-2 right-2 bg-[#FAB1AA]/90 backdrop-blur-sm rounded-full px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300 border border-[#F3D1C8]/70">
      ...
      <div className="relative z-10 mt-8 sm:mt-10 md:mt-12 flex justify-center px-4">
        <motion.a
          ...
          style={{
            backgroundImage: "linear-gradient(135deg, #FAB1AA, #F3D1C8)",
            borderColor: "#FFFFFF",
            color: "#FFFFFF",
            boxShadow: "0 6px 26px rgba(250,177,170,0.45), 0 2px 10px rgba(243,209,200,0.6)",
          }}
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          ...
          whileTap={{ scale: 0.98 }}
          onMouseEnter={(e) => {
            e.currentTarget.style.backgroundImage = "linear-gradient(135deg, #F3D1C8, #FAB1AA)";
            e.currentTarget.style.borderColor = "#FFFFFF";
            e.currentTarget.style.boxShadow = "0 10px 34px rgba(250,177,170,0.55), 0 4px 14px rgba(243,209,200,0.8)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundImage = "linear-gradient(135deg, #FAB1AA, #F3D1C8)";
            e.currentTarget.style.borderColor = "#FFFFFF";
            e.currentTarget.style.boxShadow = "0 6px 26px rgba(250,177,170,0.45), 0 2px 10px rgba(243,209,200,0.6)";
          }}
        >
          ...
          {/* Pulsing glow effect */}
          <motion.div 
            className="absolute inset-0 bg-[#FAB1AA]/25 rounded-lg sm:rounded-xl blur-xl -z-10"
            animate={{
              opacity: [0.3, 0.6, 0.3],
              scale: [1, 1.1, 1],
            }}
