  ...
  const NameItem = ({ name, align = "center" }: { name: string, align?: "left" | "center" | "right" }) => {
    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#F3D1C8]/18 to-transparent opacity-0 group-hover/item:opacity-100 transition-opacity duration-300 rounded-md" />

        <p
          className={`relative text-black text-[9px] sm:text-[10px] md:text-xs lg:text-sm font-semibold leading-snug break-words ${textAlign} group-hover/item:text-black transition-all duration-300`}
        >
          {name}
        </p>
      </div>
    ...
    <div ref={sectionRef}>
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          {/* Soft vertical gradients in pink & peach tones */}
          ...
          {/* Warm radial spotlight in peach */}
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 mt-3 sm:mt-4">
            <div className="w-8 sm:w-12 md:w-16 h-px bg-gradient-to-r from-transparent via-[#F3D1C8] to-transparent" />
            <div className="w-1.5 h-1.5 bg-[#F3D1C8] rounded-full shadow-[0_0_12px_rgba(243,209,200,0.9)]" />
            <div className="w-8 sm:w-12 md:w-16 h-px bg-gradient-to-l from-transparent via-[#F3D1C8] to-transparent" />
          </div>
        </div>
        ...
        >
          {/* Card with pink & peach theme */}
          <div className="relative bg-[#F4F4F4]/95 backdrop-blur-md rounded-xl sm:rounded-2xl overflow-hidden border border-[#F3D1C8]/70 shadow-[0_20px_60px_rgba(250,177,170,0.45)] transition-all duration-500 group">
            {/* Card content */}
              ...
              {isLoading ? (
                <div className="flex items-center justify-center py-24 sm:py-28 md:py-32">
                  <div className="flex flex-col items-center gap-4">
                    <Loader2 className="h-10 w-10 sm:h-12 sm:w-12 animate-spin text-[#FAB1AA]/70" />
                    <span className="text-[#FAB1AA]/80 font-serif text-base sm:text-lg">Loading sponsors...</span>
                  </div>
                </div>
              ) : error ? (
                <div className="flex items-center justify-center py-24 sm:py-28 md:py-32">
                  <div className="text-center">
                    ...
                    <button
                      ...
                      className="text-[#FAB1AA]/90 hover:text-[#FAB1AA] font-serif underline transition-colors duration-200"
                    >
                      Try again
                    </button>
                  </div>
                ...
                <div className="text-center py-24 sm:py-28 md:py-32">
                  <Users className="h-14 w-14 sm:h-16 sm:w-16 text-[#FAB1AA]/40 mx-auto mb-4" />
                  <p className="text-[#FAB1AA]/75 font-serif text-base sm:text-lg">No sponsors yet</p>
                </div>
              ) : (
