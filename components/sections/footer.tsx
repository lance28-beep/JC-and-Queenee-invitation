...
export function Footer() {
  ...
  return (
    <footer 
      className="relative z-20 mt-12 sm:mt-16 overflow-hidden bg-[#B47377]"
    >
      {/* Background elements with pink & peach motif */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Subtle gradient overlays */}
        <div className="absolute top-0 left-0 w-full h-1/3 bg-gradient-to-b from-[#B47377]/90 via-[#F3D1C8]/60 to-transparent" />
        <div className="absolute bottom-0 left-0 w-full h-1/3 bg-gradient-to-t from-[#B47377]/95 via-[#F3D1C8]/55 to-transparent" />
        ...
        >
          <div className="relative w-48 h-48 sm:w-56 sm:h-56 md:w-72 md:h-72 lg:w-80 lg:h-80 opacity-95">
            <Image
              ...
              priority={false}
              style={{
                // Convert monogram to white/light tone to match the footer aesthetic
                filter:
                  "brightness(0) saturate(100%) invert(100%) sepia(0%) saturate(0%) hue-rotate(0deg) brightness(100%) contrast(100%)",
              }}
            />
            {/* Glow effect behind monogram */}
            <div className="absolute inset-0 blur-3xl bg-[#F3D1C8]/30 -z-10 scale-125" />
          </div>
        </motion.div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-4 md:px-8 pb-6 sm:pb-8 md:pb-10">
        <motion.div className="grid grid-cols-1 lg:grid-cols-4 gap-5 sm:gap-6 md:gap-8 mb-6 sm:mb-8 md:mb-10" variants={staggerChildren} initial="initial" animate="animate">
          ...
          <motion.div className="lg:col-span-2" variants={fadeInUp}>
            <div className="mb-5 sm:mb-6 md:mb-8">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4 md:mb-5">
                <div className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-white/15 rounded-full flex items-center justify-center border border-[#F3D1C8]/50 flex-shrink-0 shadow-[0_0_22px_rgba(243,209,200,0.4)]">
                  <Heart className="w-5 h-5 sm:w-6 sm:h-6 md:w-6 md:h-6 text-white" fill="#F3D1C8" />
                </div>
            ...
            <motion.div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-[#F3D1C8]/50 shadow-[0_18px_45px_rgba(180,115,119,0.3)]" whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}>
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 mt-3 sm:mt-4">
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#F3D1C8] rounded-full" />
          ...
          <motion.div className="space-y-3 sm:space-y-4 md:space-y-5" variants={fadeInUp}>
            <motion.div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 border border-[#F3D1C8]/50 hover:bg-white/15 transition-all duration-300 shadow-[0_14px_40px_rgba(180,115,119,0.25)]" whileHover={{ y: -3 }} transition={{ duration: 0.2 }}>
              <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 mb-2.5 sm:mb-3 md:mb-4">
                <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 bg-white/15 rounded-full flex items-center justify-center border border-[#F3D1C8]/50 flex-shrink-0">
            ...
            <motion.div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 border border-[#F3D1C8]/50 hover:bg-white/15 transition-all duration-300 shadow-[0_14px_40px_rgba(180,115,119,0.25)]" whileHover={{ y: -3 }} transition={{ duration: 0.2 }}>
              <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 mb-2.5 sm:mb-3 md:mb-4">
                <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 bg-white/15 rounded-full flex items-center justify-center border border-[#F3D1C8]/50 flex-shrink-0">
                  <Heart className="w-4 h-4 sm:w-4.5 sm:h-4.5 md:w-5 md:h-5 text-white" fill="#F3D1C8" />
                </div>
          ...
          <motion.div className="space-y-5 sm:space-y-6 md:space-y-7" variants={fadeInUp}>
            <div>
              <h4 className={`${cormorant.className} font-semibold text-base sm:text-lg md:text-xl mb-3 sm:mb-4 md:mb-5 flex items-center gap-2 sm:gap-2.5 md:gap-3 text-white`}>
                <div className="w-1.5 sm:w-2 h-6 sm:h-7 md:h-8 bg-[#F3D1C8] rounded-full" /> Follow Us
              </h4>
              <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 flex-wrap">
                <a 
                  ...
                  className="group inline-flex items-center justify-center h-12 w-12 sm:h-14 sm:w-14 rounded-full bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-[#F3D1C8]/30"
                  aria-label="Facebook"
                >
                  <Facebook className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform duration-300" />
                </a>
                <a 
                ...
                >
                  <Instagram className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform duration-300" />
                </a>
                <a 
                  ...
                  aria-label="YouTube"
                >
                  <Music2 className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform duration-300" />
                </a>
                <a 
                  href="https://x.com/" 
                  target="_blank" 
                  ...
                  aria-label="Twitter"
                >
                  <Twitter className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform duration-300" />
                </a>
              </div>
            </div>
        ...
        {/* Bottom Row */}
        <motion.div className="border-t border-[#F3D1C8]/50 pt-5 sm:pt-6 md:pt-7" variants={fadeInUp}>
            ...
            <div className="text-center md:text-right space-y-1">
              <p className={`text-white/85 ${cormorant.className} text-xs sm:text-sm`}>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-white hover:text-[#F3D1C8] transition-colors duration-200 underline decoration-white/60 hover:decoration-[#F3D1C8]/80"
                >
                  Lance Valle
                </a>
              </p>
